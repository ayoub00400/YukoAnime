...
class MangaGenresScreen extends StatelessWidget {
  const MangaGenresScreen({super.key});
              ...
              return Column(
                ...
                children: [
                  ...
                  Expanded(
                    ...
                    onRefresh: () async {
                      BlocProvider.of<GenresCubit>(context).getMangaGenresList();
                    },
                    child: BlocBuilder<GenresCubit, GenresState>(
                      builder: (context, state) {
                        ...
                        if (state is MangaGenresLoadingFailed) {
